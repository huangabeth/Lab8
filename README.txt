...
Cloud: https://colab.research.google.com/drive/1zelX0-uVG5LsJVgqDuaHFBsitr4E6vCQ?usp=sharing
...
CNN Classifier > Check Github link and run on Colab
	or cnn.ipynb
	or direct link to code on Cloud (link in first section)
...
CNN Classifier: copy and paste github code to Colab and run there.
	Direct link also available on Cloud (in first section)
